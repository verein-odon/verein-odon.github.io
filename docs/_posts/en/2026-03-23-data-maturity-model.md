---
layout: post
title:  "Introducing ODON's Open Data Maturity Model (ODMM)"
...
To handle this consistently, regardless of domain or field, ODON developed the **ODON's Open Data Maturity Model (ODMM)**. The model assesses any dataset along two independent dimensions:
...
The ODMM is already applied in ODON's Data Catalog and guides how we evaluate and present datasets in our daily work. You can read the full model, including all levels and classification rules, on our [Open Data page](/en/open-data/#odmm).
